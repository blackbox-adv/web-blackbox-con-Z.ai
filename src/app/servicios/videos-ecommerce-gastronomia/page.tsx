...
export default function VideosEcommerceGastronomiaPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-gray-900 selection:bg-purple-500 selection:text-white">
      ...
      <SubpageNavbar activePage="servicios" ctaText="Cotizar Producción" defaultMessage="¡Hola Black Box! Me gustaría cotizar producción de videos para e-commerce o gastronomía." />
